...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Notre organisme est certifié Qualiopi. Selon votre statut, la formation peut être éligible à un financement via le CPF, votre OPCO, France Travail ou le FAF. Nous faisons le point sur votre éligibilité pendant l'Audit.",
  },
  {
    question: "Repart-on vraiment avec un système concret ?",
    answer:
      "Oui. Ce n'est pas une formation théorique : à l'issue des 2 jours, vous repartez avec votre prospection automatisée, vos agents IA configurés et vos séquences de relance opérationnelles sur vos propres outils.",
  },
  {
    question: "Faut-il savoir coder ?",
    answer:
      "Non. La formation est conçue pour des dirigeants et indépendants sans compétence technique préalable. Vous êtes accompagné pas à pas pour construire votre système de A à Z.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Le risque existe avec des outils mal configurés ou des volumes agressifs. Pendant la formation, nous vous enseignons les quotas raisonnables et les bonnes pratiques pour automatiser sans mettre votre compte en danger.",
  },
  {
    question: "Et si l'Audit montre que ce n'est pas pertinent pour moi ?",
    answer:
      "Alors nous vous le disons clairement, sans détour. L'Audit sert à établir un état des lieux honnête — pas à vous convaincre à tout prix de vous inscrire à la formation.",
  },
];
